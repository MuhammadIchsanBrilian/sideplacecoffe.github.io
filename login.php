		...
		<div class="container" style="background:white; width: 420px; border-radius:10px;">
            ...
            if (isset($_GET['pesan'])) {
                if ($_GET['pesan'] == 'berhasil') {
                    echo "<div class='alert alert-success'>User berhasil Didaftar</div>";
                } elseif ($_GET['pesan'] == 'gagal') {
                    echo "<div class='alert alert-danger'>User Error</div>";
                }
            }
            ?> 
						...
						<div class="text-center mt-2"><strong><p>Belum Punya Akun? Daftar <a class="sign-1 me-1" href="signup.php">Disini</a></p></strong>
        </div>
					</form>
				</div>
			</div>
