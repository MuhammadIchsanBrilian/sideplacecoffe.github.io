			...
			<div class="row d-flex justify-content-center">
				<div class="menu-content pb-60 col-lg-10">
					<div class="title text-center mt-4">
						<h1 class="mb-10" style="color:black;">Add Cashier</h1>
					</div>
					<form method="POST" action="csh.php">
                    <?php
            if (isset($_GET['pesan'])) {
                if ($_GET['pesan'] == 'berhasil') {
                    echo "<div class='alert alert-success'>Berhasil Menambah Kasir</div>";
                } elseif ($_GET['pesan'] == 'gagal') {
                    echo "<div class='alert alert-danger'>Kasir Error</div>";
                }
            }
            ?> 
						...
						<div class=" row d-flex justify-content-center align-content-center "><button type="submit" name="submit" class="btn btn-primary">Add</button></div>
					</form>
				</div>
			</div>
		</div>
